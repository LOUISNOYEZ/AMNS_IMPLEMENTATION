...
set_property PACKAGE_PIN T18 [get_ports {start_i}];  # "BTNU"
...
set_property IOSTANDARD LVCMOS18 [get_ports {sel_i[0]}];
set_property PACKAGE_PIN G22 [get_ports {sel_i[1]}];  # "SW1"
set_property IOSTANDARD LVCMOS18 [get_ports {sel_i[1]}];
set_property PACKAGE_PIN H22 [get_ports {sel_i[2]}];  # "SW2"
set_property IOSTANDARD LVCMOS18 [get_ports {sel_i[2]}];
set_property PACKAGE_PIN F21 [get_ports {sel_i[3]}];  # "SW3"
set_property IOSTANDARD LVCMOS18 [get_ports {sel_i[3]}];
set_property PACKAGE_PIN H19 [get_ports {sel_i[4]}];  # "SW4"
set_property IOSTANDARD LVCMOS18 [get_ports {sel_i[4]}];
set_property PACKAGE_PIN H18 [get_ports {sel_i[5]}];  # "SW5"
set_property IOSTANDARD LVCMOS18 [get_ports {sel_i[5]}];
set_property PACKAGE_PIN H17 [get_ports {sel_i[6]}];  # "SW6"
set_property IOSTANDARD LVCMOS18 [get_ports {sel_i[6]}];
set_property PACKAGE_PIN M15 [get_ports {sel_i[7]}];  # "SW7"
set_property IOSTANDARD LVCMOS18 [get_ports {sel_i[7]}];
...
create_clock -name clock -period 40.0 -waveform {0.0 20.0} [get_ports {clock_i}];
